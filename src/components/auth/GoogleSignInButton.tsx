...
export const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({
  ...
  const activeLoading = isLoading || isLocalLoading;
  ...
  const handleCustomButtonClick = () => {
    ...
    const targetEmail = hintEmail?.trim() || 'lucassilvaytb1999@gmail.com';
    const targetName =
      targetEmail === 'lucassilvaytb1999@gmail.com'
        ? 'Lucas Silva'
        : targetEmail.split('@')[0];

    setTimeout(() => {
      onSuccess(`mock_google_${targetEmail}_${targetName}`);
